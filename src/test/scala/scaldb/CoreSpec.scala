...
class CoreFieldStringSpec extends FlatSpec with Matchers {
  ...
  "Thre Core Field String Class" should "have a paged results instance the search" in {
    assume(coreFieldString.search("scaldb_first_field_value").results.isInstanceOf[Vector[SearchResult]])
  }
}
...
class CoreVectorIntSpec extends FlatSpec with Matchers {
  ...
  "The coreVectorInt class" should "have a setter for vector int" in {
    ...
    coreVectorInt.setVectorInt("scaldb_second_key",Vector(10,75,300,17)) shouldEqual Vector(10,75,300,17)
  }
  ...
  "The coreVectorInt class" should "have a setter for an vector int key returning a vector type" in {
    ...
    assume(coreVectorInt.setVectorInt("scaldb_second_key",Vector(20,90,180,7002)).isInstanceOf[Vector[Int]])
  }
  ...
  "The coreVectorInt class" should "have a gettter for a vector int key" in {
    ...
    coreVectorInt.getVectorInt("scaldb_second_key") shouldEqual Vector(20,90,180,7002)
  }
  ...
  "The coreVectorInt class" should "have a getter for vector int the same type as itself" in {
    ...
    coreVectorInt.getVectorInt("scaldb_second_key_non_presence",Vector(7,2,10,579)) shouldEqual Vector(7,2,10,579)
  }
  ...
  "The coreVectorInt class" should "have a setter overwrite key" in {
    ...
    coreVectorInt.setVectorInt("scaldb_second_key",Vector(300,20,70,7009)) shouldEqual Vector(300,20,70,7009)
    coreVectorInt.getVectorInt("scaldb_second_key") should not equal Vector(10,75,300,17)
  }
}
